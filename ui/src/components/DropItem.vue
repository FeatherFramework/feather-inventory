<template>
    <div class="bg-red-400 w-50 h-30 p-10 rounded-md dropzone z-50" id="dropit">
        <div class="w-full h-full flex content-center items-center flex-row">
            <svg class="h-10 w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <path
